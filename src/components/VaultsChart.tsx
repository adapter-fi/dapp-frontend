...
export const VaultsChart = () => {
  ...
  const chartData = pendleData?.map(
    (
      ...
      underlyingAPR: underlyingApy !== undefined ? formatPercentage(underlyingApy * 100) : 'TBD',
      autocompoundedAPY: underlyingApy !== undefined ? formatPercentage(impliedApy * 100) : 'TBD',
